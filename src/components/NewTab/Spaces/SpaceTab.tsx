...
const SpaceTab = ({
  ...
  return (
    !isArchived && (
      <li
        className={`relative border border-l-0 border-white p-4 text-xl first-of-type:border-t-0  ${linkClasses} group/space-tab flex justify-between hover:bg-orange-900`}
      >
