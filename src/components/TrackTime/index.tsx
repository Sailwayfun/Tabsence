...
const TrackTime = () => {
  ...
  return (
    <>
      ...
      {urlDurations.length === 0 && (
        <div className="flex min-h-screen max-w-full flex-col items-center gap-4 rounded-lg border bg-slate-100 p-8 shadow-md">
          <img src={noData} alt="no data" className="mx-auto w-full" />
